...
public class TmtModData {
    ...
    public record ModPedia(String modid, String modName) {
        ...
        public static final ModPedia OTBWG  = new ModPedia("biomeswevegone", "Oh The Biomes We've Gone");
    ...
    public record TreePedia(String treeType) {
        ...
        public ResourceLocation log() {
            if (!this.treeType.equals("florus")) {
                return ModPedia.OTBWG.id(this.treeType + "_log");
            }
            else  return ModPedia.OTBWG.id(this.treeType + "_stem");
        }

        public ResourceLocation wood() {
            return ModPedia.OTBWG.id(this.treeType + "_wood");
        }
        ...
        public ResourceLocation strippedWood() {
            return ModPedia.OTBWG.id("stripped_" + this.treeType + "_wood");
        }
        ...
        public ResourceLocation stairs() {
            return ModPedia.OTBWG.id(this.treeType + "_stairs");
        }

        public ResourceLocation slab() {
            return ModPedia.OTBWG.id(this.treeType + "_slab");
        }

        public ResourceLocation fence() {
            return ModPedia.OTBWG.id(this.treeType + "_fence");
        }

        public ResourceLocation fenceGate() {
            return ModPedia.OTBWG.id(this.treeType + "_fence_gate");
        }

        public ResourceLocation door() {
            return ModPedia.OTBWG.id(this.treeType + "_door");
        }

        public ResourceLocation trapdoor() {
            return ModPedia.OTBWG.id(this.treeType + "_trapdoor");
        }

        public ResourceLocation pressurePlate() {
            return ModPedia.OTBWG.id(this.treeType + "_pressure_plate");
        }

        public ResourceLocation button() {
            return ModPedia.OTBWG.id(this.treeType + "_button");
        }

        public ResourceLocation bookshelf() {
            return ModPedia.OTBWG.id(this.treeType + "_bookshelf");
        }

        public ResourceLocation craftingTable() {
            return ModPedia.OTBWG.id(this.treeType + "_crafting_table");
        }

        public ResourceLocation leaves() {
            return ModPedia.OTBWG.id(this.treeType + "_leaves");
        }

        public ResourceLocation sapling() {
            return ModPedia.OTBWG.id(this.treeType + "_sapling");
        }

        public ResourceLocation sign() {
            return ModPedia.OTBWG.id(this.treeType + "_sign");
        }

        public ResourceLocation hangingSign() {
            return ModPedia.OTBWG.id(this.treeType + "_hanging_sign");
        }

        public ResourceLocation boat() {
            return ModPedia.OTBWG.id(this.treeType + "_boat");
        }

        public ResourceLocation chestBoat() {
            return ModPedia.OTBWG.id(this.treeType + "_chest_boat");
        }
    ...
    public record HerbaPedia (String herbType, int yield,  ClocheRenderType renderType, PlantCategory category) {
        ...
        public ResourceLocation seedItem() {
            if (this.herbType.equals("white_puffball_cap")) {
                return ModPedia.OTBWG.id("white_puffball_spores");
            } else if (this.herbType.equals("pale_pumpkin")) {
                return ModPedia.OTBWG.id("pale_pumpkin_seeds");
            } else return ModPedia.OTBWG.id(this.herbType);
        }
        ...
        public ResourceLocation cropRenderBlock() {
            if (this.herbType.equals("oddion_bulb")) {
                return ModPedia.OTBWG.id(this.herbType.replace("_bulb", "_crop"));
            } else if (this.herbType.equals("blueberries")) {
                return ModPedia.OTBWG.id("blueberry_bush");
            } else if (this.herbType.equals("white_puffball_cap")) {
                return ModPedia.OTBWG.id(this.herbType.replace("_cap", ""));
            } else if (this.category.equals(PlantCategory.REED)) {
                return ModPedia.OTBWG.id(herbType.replace("_shoot", ""));
            } else return ModPedia.OTBWG.id(this.herbType);
        }
        ...
        public ResourceLocation stemRenderBlock() {
            if (this.herbType.equals("pale_pumpkin")) {
                return ModPedia.OTBWG.id("pale_pumpkin_stem");
            }
        ...
        public ResourceLocation attachedStemRenderBlock() {
            if (this.herbType.equals("pale_pumpkin")) {
                return ModPedia.OTBWG.id("attached_pale_pumpkin_stem");
            }
        ...
        public ResourceLocation produceItem() {
            return ModPedia.OTBWG.id(this.herbType);
        }
