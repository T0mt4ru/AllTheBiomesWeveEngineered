...
public class TmtClocheRecipes {
    ...
    private static void generateClocheRecipe(RecipeOutput clocheOutput, RecipeOutput clocheFDOutput, Ingredient seedItem, ResourceLocation cropOutput, int cropYield,
        ...
        ResourceLocation id = ResourceLocation.fromNamespaceAndPath(Tmt_otbweMain.MODID, "cloche/" + recipeName);
        ...
        if (supportsRichSoil) {
            ...
            ClocheRecipe fdRecipe = new ClocheRecipe(
                    outputs,
                    seedItem,
                    Ingredient.of(TagKey.create(Registries.ITEM, ResourceLocation.fromNamespaceAndPath(Tmt_otbweMain.MODID, "compat/rich_soil"))),
                    time /2,
                    fluidIngredient,
                    clocheRenderFunction
            );

            ResourceLocation fdID = ResourceLocation.fromNamespaceAndPath(Tmt_otbweMain.MODID, "cloche/" + recipeName + "_on_rich_soil");
